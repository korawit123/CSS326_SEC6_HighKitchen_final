...
<body>
    <section class="header">
        <div class="banner">
            <div class="slider">
                <img src="images/BG7.jpg" id="sliderimg">
            </div>
            <div class="overlay">
                <div class="navbar">
                    <div class="logo">
                    ...
                    <div class="bar">
                        <ul>
                            ...
                            <li><a href="#"   style="background-color: white; color: black; border-radius: 15px;" >CONTACT</a></li>
                        </ul>
                    </div>
                    <div class="account">
                    <div class="imguser">
                ...
                <div class="butt">
                  <div class="left">
                    <h1>High Kitchen</h1>
                    <p>Needto get in touch with us? Either fill out the form <br>
                       with your inquiry or find the department email you'd <br>
                       like to contact below.
                  </p>
                  </div>
                  <div class="rigth">
                    <input class="ab" type="text" placeholder="First name">
                    <input class="ab" type="text" placeholder="Last name">
                    <input class="cd" type="text" placeholder=" Email " required>
                    <input class="cd" type="text" placeholder="What can we help you with?" required>
                    <input class="sub" type="submit" value="Sent">
                  </div>
                </div>
